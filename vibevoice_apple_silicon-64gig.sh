...
#
# Usage:
#   bash vibevoice_apple_silicon.sh                # install everything + launch web UI
#   bash vibevoice_apple_silicon.sh --model microsoft/VibeVoice-1.5B
...
MODEL_ID="aoi-ot/VibeVoice-Large"      # community mirror of the 7B/Large weights
PORT="${PORT:-7860}"
SHARE=0
CLEAN=0
